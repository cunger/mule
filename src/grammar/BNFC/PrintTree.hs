...
instance Print Tree where
  prt i e = case e of
    ...
    Branch id marking trees -> prPrec i 0 (concatD [prt 0 id, prt 0 marking, doc (showString "[ "), prt 0 trees, doc (showString " ]")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString " ,"), prt 0 xs])
instance Print Marking where
  prt i e = case e of
    Plus -> prPrec i 0 (concatD [doc (showString "+")])
    Minus -> prPrec i 0 (concatD [doc (showString "-")])
    None -> prPrec i 0 (concatD [doc (showString "o")])
